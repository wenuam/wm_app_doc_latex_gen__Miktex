...
\def\bbl@ca@islamicvl@x#1#2-#3-#4\@@#5#6#7{%
  \edef\bbl@tempa{%
    \fpeval{ floor(\bbl@cs@jd{#2}{#3}{#4})+0.5 #1}}%
  \edef#5{%
    \fpeval{ floor(((30*(\bbl@tempa-1948439.5)) + 10646)/10631) }}%
  \edef#6{\fpeval{
    min(12,ceil((\bbl@tempa-(29+\bbl@cs@isltojd{#5}{1}{1}))/29.5)+1) }}%
  \edef#7{\fpeval{ \bbl@tempa - \bbl@cs@isltojd{#5}{#6}{1} + 1} }}
...
\def\bbl@ca@islamcuqr@x#1#2-#3-#4\@@#5#6#7{%
  ...
  \edef\bbl@tempd{\fpeval{ % (Julian) day
  ...
  \bbl@foreach\bbl@cs@umalqura@data{%
    ...
    \ifnum##1>\bbl@tempd\else
      ...
      \edef\bbl@tempb{##1}%
    \fi}%
  \edef\bbl@templ{\fpeval{ \bbl@tempe + 16260 + 949 }}% month~lunar
  \edef\bbl@tempa{\fpeval{ floor((\bbl@templ - 1 ) / 12) }}% annus
  \edef#5{\fpeval{ \bbl@tempa + 1  }}%
  \edef#6{\fpeval{ \bbl@templ - (12 * \bbl@tempa) }}%
  \edef#7{\fpeval{ \bbl@tempd - \bbl@tempb + 1 }}}
